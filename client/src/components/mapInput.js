...
export default function MapInput (props) {
    ...
    return (
      ...
      <div class = " flex bg-white-500 inset-x-0 top-0 text-center bg-orange-500 p-3">
          <Link href="/">
          <a>
            <h1 className="text-black text-3xl font-bold mt-6">Elena</h1>
          </a>
          </Link>
          <div class = "flex-1 bg-gray-300 mx-32  text-center rounded-lg">
            <label for = "startPoint" className = "ml-1"> Start: </label>
            ...
            <label for = "minMax"> Elevation Gain: </label>
            ...
            <label for = "%" className = "ml-5"> Path length (%): </label>
            ...
            <br/>
            <small class = "block inset-x-0 top-0 text-center">Click a start and an end point on the map, select to minimize or maximize elevation gain, input the maximum percentage of shortest path, then click "Calculate Path" to render your path.</small>
            <small class = "block inset-x-0 top-0 text-center">Click the map again to begin calculating a new path.</small>
